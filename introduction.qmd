...
![](media/save_copy.png){.bordered .half fig-align="center"}
...
![](media/quarto_anatomy.png){.two-thirds fig-align="center"}
...
Click (![](media/yes_button.png){.inline-image height="1em"}) when you are done.
