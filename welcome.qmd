...
-   (optional) The GitHub repo for this course is at <https://github.com/pm0kjp/intro-to-r-for-clinical-data-rmed2023>
...
Click the "yes" button (![](media/yes_button.png){.inline-image height="1em"}) in the Participants window. Then tell us your location (city, country) in the Chat window.
